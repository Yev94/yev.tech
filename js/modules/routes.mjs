export let pages = {
  ...
  '#/lenguajes/php/prestashop': './html/lenguajes/php/prestashop',
  '#/lenguajes/php/prestashop/plugin': './html/lenguajes/php/prestashop/plugin.html',
  ...
  '#/i2/1/ec/monociclo': './html/i2/1/ec/monociclo',
  '#/i2/1/ec/monociclo/instruccion-r-i': './html/i2/1/ec/monociclo/instruccion-r-i.html',
  '#/i2/1/ec/monociclo/instruccion-j': './html/i2/1/ec/monociclo/instruccion-j.html',
  '#/i2/1/ec/multiciclo': './html/i2/1/ec/multiciclo',
  '#/i2/1/ec/multiciclo/instruccion-r': './html/i2/1/ec/multiciclo/instruccion-r.html',
  '#/i2/1/ec/elementos/banco-registros': './html/i2/1/ec/elementos/banco-registros.html',
  '#/i2/1/ec/elementos/memoria': './html/i2/1/ec/elementos/memoria.html',
  '#/i2/1/ec/elementos/control': './html/i2/1/ec/elementos/control.html',
  '#/i2/1/ec/elementos/alucontrol': './html/i2/1/ec/elementos/alucontrol.html',
  ...
  '#/plataformas/cloudflare': './html/plataformas/cloudflare',
  ...
  '#/plataformas/vs-code/playwright': './html/plataformas/vs-code/playwright.html',
  '#/plataformas/vs-code/snippets': './html/plataformas/vs-code/snippets.html',
  '#/plataformas/vs-code/testing': './html/plataformas/vs-code/testing.html',
  '#/plataformas/wamp': './html/plataformas/wamp',
  '#/plataformas/wamp/phpmyadmin': './html/plataformas/wamp/phpmyadmin.html',

  '#/plataformas/prestashop': './html/plataformas/prestashop',
  '#/plataformas/prestashop/bugs/v-1-7-6-4': './html/plataformas/prestashop/bugs/v-1-7-6-4.html',
  '#/plataformas/prestashop/modulos/google-merchant': './html/plataformas/prestashop/modulos/google-merchant.html',
  '#/plataformas/prestashop/modulos/reviews': './html/plataformas/prestashop/modulos/reviews.html',
  '#/plataformas/prestashop/configuracion-avanzada': './html/plataformas/prestashop/configuracion-avanzada.html',
  '#/plataformas/prestashop/instalar-prestashop-local': './html/plataformas/prestashop/instalar-prestashop-local.html',
  '#/plataformas/prestashop/creacion-modulos': './html/plataformas/prestashop/creacion-modulos.html',
  '#/plataformas/prestashop/cambios': './html/plataformas/prestashop/cambios.html',
  '#/plataformas/prestashop/features': './html/plataformas/prestashop/features.html',

  '#/plataformas/wordpress': './html/plataformas/wordpress',
  '#/plataformas/wordpress/configuracion-avanzada': './html/plataformas/wordpress/configuracion-avanzada.html',
  '#/plataformas/wordpress/instalar-wordpress-local': './html/plataformas/wordpress/instalar-wordpress-local.html',
